...
public class NageWaza extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nagewaza);
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction().add(R.id.contentFrame,
                    Fragment.instantiate(NageWaza.this, Fragments.MAIN.getFragment())).commit();
        } else {
            currentSelectedPosition = savedInstanceState.getInt(STATE_SELECTED_POSITION);
        }

        navigationItems = new ArrayList<>();
        navigationItems.add(new NavigationDrawerItem(getString(R.string.fragment_cinza), true));
        navigationItems.add(new NavigationDrawerItem(getString(R.string.fragment_azul), true));
        navigationItems.add(new NavigationDrawerItem(getString(R.string.fragment_amarela), true));
        navigationItems.add(new NavigationDrawerItem(getString(R.string.fragment_laranja), true));
        ...
        switch (position) {
                ...
                if (!(getSupportFragmentManager().getFragments()
                    ...
                    getSupportFragmentManager().beginTransaction()
                            .replace(R.id.contentFrame, Fragment
                                    .instantiate(NageWaza.this, Fragments.CINZA.getFragment()))
                            .commit();
                }
                break;
            case 1:
                if (!(getSupportFragmentManager().getFragments().get(0) instanceof FaixaAzul)) {
                    getSupportFragmentManager().beginTransaction()
                            .replace(R.id.contentFrame, Fragment
                                    .instantiate(NageWaza.this, Fragments.AZUL.getFragment()))
                            .commit();
                }
                break;
            case 2:
                if (!(getSupportFragmentManager().getFragments().get(0) instanceof FaixaAmarela)) {
                    getSupportFragmentManager().beginTransaction()
                            .replace(R.id.contentFrame, Fragment
                                    .instantiate(NageWaza.this, Fragments.AMARELA.getFragment()))
                            .commit();
                }
                break;
            case 3:
                if (!(getSupportFragmentManager().getFragments().get(0) instanceof FaixaLaranja)) {
                    getSupportFragmentManager().beginTransaction()
                            .replace(R.id.contentFrame, Fragment
                                    .instantiate(NageWaza.this, Fragments.LARANJA.getFragment()))
                            .commit();
                }
                break;
            case 4:
                if (!(getSupportFragmentManager().getFragments().get(0) instanceof FaixaVerde)) {
                    getSupportFragmentManager().beginTransaction()
                            .replace(R.id.contentFrame, Fragment
                                    .instantiate(NageWaza.this, Fragments.VERDE.getFragment()))
                            .commit();
                }
                break;
            case 5:
                if (!(getSupportFragmentManager().getFragments().get(0) instanceof FaixaRoxa)) {
                    getSupportFragmentManager().beginTransaction()
                            .replace(R.id.contentFrame, Fragment
                                    .instantiate(NageWaza.this, Fragments.ROXA.getFragment()))
                            .commit();
                }
                break;
            case 6:
                if (!(getSupportFragmentManager().getFragments().get(0) instanceof FaixaMarrom)) {
                    getSupportFragmentManager().beginTransaction()
                            .replace(R.id.contentFrame, Fragment
                                    .instantiate(NageWaza.this, Fragments.MARROM.getFragment()))
                            .commit();
                }
                break;
            case 7:
            ...
            case 8:
                if (!(getSupportFragmentManager().getFragments().get(0) instanceof FragmentAbout)) {
                    getSupportFragmentManager().beginTransaction()
                            .replace(R.id.contentFrame, Fragment
                                    .instantiate(NageWaza.this, Fragments.ABOUT.getFragment()))
                            .commit();
                }
                break;
        }
