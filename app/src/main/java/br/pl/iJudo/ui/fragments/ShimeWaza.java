...
public class ShimeWaza extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_shimewaza, container,
                false);

        values = getResources().getStringArray(R.array.shimewaza);
