...
public class KansetsuWaza extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_kansetsuwaza, container,
                false);

        values = getResources().getStringArray(R.array.kansetsuwaza);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(getActivity(),
                R.layout.simple_list_item_1_golpes_chao, R.id.golpename, values);
